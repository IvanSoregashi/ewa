...
from library.filetypes import mimetypes_utils

mimetypes_path = Path(__file__).parent / "samples" / "mimetype" / "mime.types"
...
def test_guess_file_type(filepath, expected):
    """Test strict adherence to latest standardized mappings in our mime.types file"""
